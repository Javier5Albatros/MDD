...
namespace UPM_IPS.MPJAAMPrototool
{
	...
	/// </remarks>
	public partial class MPJAAMPrototoolHelpKeywordHelper : MPJAAMPrototoolHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MPJAAMPrototoolHelpKeywordHelper.
		/// </summary>
		protected MPJAAMPrototoolHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MPJAAMPrototoolHelpKeywordHelper.
		/// </summary>
		public static MPJAAMPrototoolHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MPJAAMPrototoolHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MPJAAMPrototoolHelpKeywordHelperBase.
		/// </summary>
		protected MPJAAMPrototoolHelpKeywordHelperBase()
			: base() { }
