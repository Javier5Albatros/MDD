...
namespace UPM_IPS.MPJAAMPrototool
{
	...
	/// </summary>
	internal partial class MPJAAMPrototoolCommandSet : MPJAAMPrototoolCommandSetBase
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolCommandSet.
		/// </summary>
		public MPJAAMPrototoolCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MPJAAMPrototoolCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolCommandSetBase.
		/// </summary>
		protected MPJAAMPrototoolCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMPJAAMPrototoolExplorerCommand,
				typeof(MPJAAMPrototoolEditorFactory).GUID);
		...
		{
			MPJAAMPrototoolExplorerToolWindow explorer = this.MPJAAMPrototoolExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MPJAAMPrototoolDocData CurrentMPJAAMPrototoolDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MPJAAMPrototoolDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MPJAAMPrototoolDocView CurrentMPJAAMPrototoolDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MPJAAMPrototoolDocView;
			}
		}
		...
		/// </summary>
		protected MPJAAMPrototoolExplorerToolWindow MPJAAMPrototoolExplorerToolWindow
		{
			get
			{
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MPJAAMPrototoolExplorerToolWindow), true) as MPJAAMPrototoolExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MPJAAMPrototoolExplorerToolWindow explorerWindow = this.MPJAAMPrototoolExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MPJAAMPrototoolClipboardCommandSet : MPJAAMPrototoolClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolClipboardCommandSet.
		/// </summary>
		public MPJAAMPrototoolClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MPJAAMPrototoolClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolClipboardCommandSetBase.
		/// </summary>
		protected MPJAAMPrototoolClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
