...
namespace UPM_IPS.MPJAAMPrototool
{
	...
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.VentanasToolboxTab",
					"@VPrincipalTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.VPrincipalTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"VPrincipalTool1", 
					"@VPrincipalTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 0)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.VentanasToolboxTab",
					"@VSecundariaTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.VSecundariaTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"VSecundariaTool1", 
					"@VSecundariaTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 1)]
	...
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
					"@MenuTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.MenuTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"MenuTool1", 
					"@MenuTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 2)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
					"@ItemMenuTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.ItemMenuTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ItemMenuTool1", 
					"@ItemMenuTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 3)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
					"@BotonTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.BotonTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"BotonTool1", 
					"@BotonTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 4)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
					"@EstadoFinTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.EstadoFinTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"EstadoFinTool1", 
					"@EstadoFinTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 5)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
					"@ItemNavegacion_VentanaTool1ToolboxItem;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					"UPM_IPS.MPJAAMPrototool.ItemNavegacion_VentanaTool1ToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ItemNavegacion_VentanaTool1", 
					"@ItemNavegacion_VentanaTool1ToolboxBitmap;UPM_IPS.MPJAAMPrototool.Dsl.dll", 
					0xff00ff,
					Index = 6)]
	[VSShell::ProvideStaticToolboxItem("UPM_IPS.MPJAAMPrototool.NavegaciónToolboxTab",
