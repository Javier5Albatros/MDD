...
namespace UPM_IPS.MPJAAMPrototool
{
	...
	/// </summary>
	internal partial class MPJAAMPrototoolExplorer : MPJAAMPrototoolExplorerBase
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolExplorer.
		/// </summary>
		public MPJAAMPrototoolExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MPJAAMPrototoolExplorerToolWindow.
	/// </summary>
	internal abstract class MPJAAMPrototoolExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MPJAAMPrototoolExplorerBase.
		/// </summary>
		protected MPJAAMPrototoolExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MPJAAMPrototoolExplorerMenu;
			}
		}
		...
		{
			get { return global::UPM_IPS.MPJAAMPrototool.TapizPrototool.DomainClassId; }
		}
